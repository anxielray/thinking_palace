...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[414], {
    ...
    414: function(e, t, n) {
        ...
        function v(e, t, n, r, o, l) {
            ...
            let f = l ? e.prefetch(t, o) : e.prefetch(t, n, r);
        ...
        let _ = o.default.forwardRef(function(e, t) {
            let n, r;
            let {href: f, as: h, children: _, prefetch: m=null, passHref: C, replace: k, shallow: M, scroll: P, locale: j, onClick: O, onMouseEnter: E, onTouchStart: L, legacyBehavior: x=!1, ...R} = e;
            n = _,
            x && ("string" == typeof n || "number" == typeof n) && (n = o.default.createElement("a", null, n));
            let w = !1 !== m
              , I = null === m ? b.PrefetchKind.AUTO : b.PrefetchKind.FULL
              ...
              , {href: A, as: D} = o.default.useMemo( () => {
                ...
                return {
                    href: e,
                    as: h ? (0,
                    l.resolveHref)(T, h) : t || e
                }
            }
            , [T, f, h])
              , N = o.default.useRef(A)
              , H = o.default.useRef(D);
            x && (r = o.default.Children.only(n));
            let q = x ? r && "object" == typeof r && r.ref : t
              , [z,B,F] = (0,
            d.useIntersection)({
                rootMargin: "200px"
            })
              , G = o.default.useCallback(e => {
                (H.current !== D || N.current !== A) && (F(),
                H.current = D,
                N.current = A),
                z(e),
            ...
            , [D, A, B, j, w, null == T ? void 0 : T.locale, U, K, I]);
            let J = {
                ref: G,
                onClick(e) {
                    x || "function" != typeof O || O(e),
                    x && r.props && "function" == typeof r.props.onClick && r.props.onClick(e),
                    U && !e.defaultPrevented && function(e, t, n, r, l, f, a, i, c, s) {
                ...
                onMouseEnter(e) {
                    ...
                    x && r.props && "function" == typeof r.props.onMouseEnter && r.props.onMouseEnter(e),
                    U && (w || !K) && v(U, A, D, {
                        locale: j,
                        priority: !0,
                ...
                onTouchStart(e) {
                    ...
                    x && r.props && "function" == typeof r.props.onTouchStart && r.props.onTouchStart(e),
                    U && (w || !K) && v(U, A, D, {
                        locale: j,
                        priority: !0,
                        bypassPrefetchedCheck: !0
            ...
            a.isAbsoluteUrl)(D))
                ...
                let e = void 0 !== j ? j : null == T ? void 0 : T.locale
                  , t = (null == T ? void 0 : T.isLocaleDomain) && (0,
                p.getDomainLocale)(D, e, null == T ? void 0 : T.locales, null == T ? void 0 : T.domainLocales);
                J.href = t || (0,
                y.addBasePath)((0,
                i.addLocale)(D, e, null == T ? void 0 : T.defaultLocale))
            }
            return x ? o.default.cloneElement(r, J) : o.default.createElement("a", {
                ...R,
                ...J
            }, n)
        })
